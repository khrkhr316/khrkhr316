...
# 👋 I'm AI Developer KHR

### “기술로 문제를 해결하는 개발자”

Python 기반 AI 서비스와 백엔드 개발을 공부하며  
실제 동작하는 서비스를 만드는 것을 좋아합니다.
...
### 기술 스택
`Python` `FastAPI` `OpenAI API` `Docker`
